...
<body>
 ...
 <center>
     ...
     <form   action="finalupdate.php" method="post">
       ...
       if(isset($_SESSION['user_id'])&&$user_type==0){
   ...
   if($query){
    ...
    <div class="box">
        ...
        <a class="save" href="Select_your_order.php" > Back Home </a>
    </div>
    ...
    <?php
        ...
        ////
        $query=mysqli_query($con,"Update cars set phone_Number='".$_POST['phone_Number']."' ,FullName='".$_POST['FullName']."' , birth_date='".$_POST['birth_date']."',email='".$_POST['email']."',password='".$_POST['password']."'where cars_id='".$_POST['id']."'");
  ...
  <input class="pro" type="hidden"  name="id" placeholder="Phone Number"value="<?php echo $row['cars_id']?>">
   ...
   <a class="save"href="previewdriverorder.php" > Back Home </a>
        ...
        elseif(isset($_SESSION['user_id'])&&$user_type==1){
          if(isset($_POST['submit'])){
      ...
      if($query){
       ...
       <div class="box">
           ...
           <button name="submit" type="submit" action="finalupdate.php" class="save">Save Changes</button>
           <a class="save" href="previewAdmin.php" > Back Home </a>
       </div>
